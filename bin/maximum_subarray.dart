...
🧠 Penggunaan Spesifik dalam Algoritma Kadane
    Dalam kode ini:
    ...
    2. .clamp(nums[i], double.infinity)
      ...
      👉 Mengapa?
      Karena jika jumlah subarray sebelumnya menjadi negatif, 
      maka menambahkannya ke elemen saat ini hanya akan memperburuk hasil. 
